...
wrap!(jsapi: pub fn JS_ExecuteScript2(cx: *mut JSContext, envChain: *mut EnvironmentChain, script: Handle<*mut JSScript>, rval: MutableHandle<Value>) -> bool);
wrap!(jsapi: pub fn JS_ExecuteScript3(cx: *mut JSContext, envChain: *mut EnvironmentChain, script: Handle<*mut JSScript>) -> bool);
